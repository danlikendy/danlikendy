...
RAG · NLP · LLM integrations · ETL for ML

Moscow · [tsygantsov.ru](https://tsygantsov.ru) · [LinkedIn](https://www.linkedin.com/in/tsygantsov) · [Habr](https://habr.com/ru/users/luvgreyair)

</div>

I ship models and the data around them: retrieval, evaluation, Python services, SQL. Currently building [**Voicaj**](https://voicaj.ru) — speech and text become structured records (tasks, calendar, health, finance) via YandexGPT, LangChain, and intent-style routing. Previously: corporate RAG (~60% faster document search) and data-quality tooling (~40% fewer bad loads).

M.S. Machine Learning @ [Finance University](https://www.fa.ru/) (2026–2028).
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,pytorch,sklearn,ts,nextjs,nodejs,postgres,docker,fastapi,redis,githubactions" alt="stack" />
</p>

Python · PyTorch · scikit-learn · LangChain · SQL · PostgreSQL · FastAPI · TypeScript · Next.js · Docker · Airflow · MLflow
...
[tsygantsov.ru](https://tsygantsov.ru) ·
[linkedin.com/in/tsygantsov](https://www.linkedin.com/in/tsygantsov) ·
[habr.com/users/luvgreyair](https://habr.com/ru/users/luvgreyair) ·
[kaggle.com/atsygantsov](https://www.kaggle.com/atsygantsov)
